...
[ ] Dashboard Layout Suggestion
    - Top Row (KPI Cards):
        - Total Balance | Monthly Income | Monthly Expenses | Savings Rate
    -Second Row:
        - Cash Flow Trend Chart (6 months) | Category Breakdown Pie Chart
    - Third Row:
    - Account Balance Distribution | Top 5 Spending Categories
    - Bottom Row:
